...
if ( ! class_exists( 'Ava_Smart_Filters_Data' ) ) {

	/**
	 * Define Ava_Smart_Filters_Data class
	 */
	class Ava_Smart_Filters_Data {
		...
		public function get_filters_by_type( $type ) {
			...
			$filters = get_posts( array(
				'post_type'      => ava_smart_filters()->post_type->slug(),
				'posts_per_page' => -1,
				'meta_query'     => array(
					array(
						'key'     => '_filter_type',
		...
		public function get_terms_objects( $tax = null, $child_of_current = false ) {
			...
			return apply_filters( 'ava-smart-filters/data/terms-objects', $terms, $tax, $child_of_current );
		...
		public function get_terms_for_options( $tax = null, $child_of_current = false ) {
			...
			return apply_filters( 'ava-smart-filters/data/terms-for-options', $options, $tax, $child_of_current );
