...
if ( ! class_exists( 'Ava_Smart_Filters_Range_Filter' ) ) {

	/**
	 * Define Ava_Smart_Filters_Range_Filter class
	 */
	class Ava_Smart_Filters_Range_Filter extends Ava_Smart_Filters_Filter_Base {
		...
		public function get_name() {
			return __( 'Range', 'ava-smart-filters' );
		}
		...
		public function prepare_args( $args ) {
			...
			return array(
				...
				'prefix'           => ava_smart_filters_macros( $prefix ),
				'suffix'           => ava_smart_filters_macros( $suffix ),
				'filter_id'        => $filter_id,
