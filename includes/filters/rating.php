...
if ( ! class_exists( 'Ava_Smart_Filters_Rating_Filter' ) ) {

	/**
	 * Define Ava_Smart_Filters_Rating_Filter class
	 */
	class Ava_Smart_Filters_Rating_Filter extends Ava_Smart_Filters_Filter_Base {
		...
		public function get_name() {
			return __( 'Rating', 'ava-smart-filters' );
		}
