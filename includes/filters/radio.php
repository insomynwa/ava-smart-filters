...
if ( ! class_exists( 'Ava_Smart_Filters_Radio_Filter' ) ) {

	/**
	 * Define Ava_Smart_Filters_Radio_Filter class
	 */
	class Ava_Smart_Filters_Radio_Filter extends Ava_Smart_Filters_Filter_Base {
		...
		public function get_name() {
			return __( 'Radio', 'ava-smart-filters' );
		}
