...
if ( ! class_exists( 'Ava_Smart_Filters_Color_Image_Filter' ) ) {

	/**
	 * Define Ava_Smart_Filters_Color_Image_Filter class
	 */
	class Ava_Smart_Filters_Color_Image_Filter extends Ava_Smart_Filters_Filter_Base {
		...
		public function get_name() {
			return __( 'Visual', 'ava-smart-filters' );
		}
		...
		public function prepare_args( $args ) {
			...
			switch ( $source ) {
				case 'taxonomies':
					...
					$current_options = ava_smart_filters()->data->get_terms_for_options( $tax, $only_child );
				...
				case 'custom_fields':
					...
					$current_options = ava_smart_filters()->data->maybe_parse_repeater_options( $current_options );
					$query_type      = 'meta_query';
					$query_var       = get_post_meta( $filter_id, '_query_var', true );
