<?php
/**
 * Class: Ava_Smart_Filters_Provider_WooCommerce_Shortcode
...
if ( ! class_exists( 'Ava_Smart_Filters_Provider_WooCommerce_Shortcode' ) ) {

	/**
	 * Define Ava_Smart_Filters_Provider_WooCommerce_Shortcode class
	 */
	class Ava_Smart_Filters_Provider_WooCommerce_Shortcode extends Ava_Smart_Filters_Provider_Base {
		...
		public function get_name() {
			return __( 'WooComerce Shortcode', 'ava-smart-filters' );
		}
