...
class Ava_Smart_Filters_Checkboxes_Widget extends Ava_Smart_Filters_Base_Widget {

	public function get_name() {
		return 'ava-smart-filters-checkboxes';
	}

	public function get_title() {
		return __( 'Checkboxes Filter', 'ava-smart-filters' );
	}

	public function get_icon() {
		return 'ava-smart-filters-checkboxes-filter';
	}
	...
	public function register_filter_style_controls() {
		...
		$css_scheme = apply_filters(
			'ava-smart-filters/widgets/checkboxes/css-scheme',
			array(
