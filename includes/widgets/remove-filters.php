...
class Ava_Smart_Filters_Remove_Filters_Widget extends Widget_Base {

	public function get_name() {
		return 'ava-smart-filters-remove-filters';
	}

	public function get_title() {
		return __( 'Remove Filters', 'ava-smart-filters' );
	}

	public function get_icon() {
		return 'ava-smart-filters-remove-filter';
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'remove_filters_text',
			array(
				'label'     => esc_html__( 'Remove button text', 'ava-smart-filters' ),
				'type'      => Controls_Manager::TEXT,
				'default'   => __( 'Remove filters', 'ava-smart-filters' ),
			)
		);
		...
		$css_scheme = apply_filters(
			'ava-smart-filters/widgets/remove-filters/css-scheme',
			array(
				'filter'               => '.ava-filter',
				'remove-filters'        => '.ava-remove-all-filters',
				'remove-filters-button' => '.ava-remove-all-filters__button',
			)
		);
	...
	protected function render() {
		...
		include ava_smart_filters()->get_template( 'common/remove-filters.php' );
		echo '</div>';
