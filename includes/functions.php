 ...
 * @return array
 */
function ava_smart_filters_woo_prices() {
 ...
 * @return string
 */
function ava_smart_filters_woo_currency_symbol() {

	$currency = apply_filters( 'ava-smart-filters/woocommerce/currency-symbol', get_woocommerce_currency_symbol() );
 ...
 */
function ava_smart_filters_macros( $string, $field_value = null ) {

	$macros = apply_filters( 'ava-smart-filters/macros/macros-list', array(
		'woocommerce_currency_symbol' => 'ava_smart_filters_woo_currency_symbol',
	) );
