...
?>
<div class="ava-radio-list" <?php $this->filter_data_atts( $args, $filter ); ?>><?php

	include ava_smart_filters()->get_template( 'common/filter-label.php' );

	echo '<div class="ava-radio-list-wrapper">';
	...
	if ( $by_parents ) {
		...
		$args['item_template'] = ava_smart_filters()->get_template( 'filters/radio-item.php' );
		...
		foreach ( $options as $value => $label ) {
			...
			include ava_smart_filters()->get_template( 'filters/radio-item.php' );
