...
?>
<div class="ava-color-image-list" <?php $this->filter_data_atts( $args, $filter ); ?>><?php

	include ava_smart_filters()->get_template( 'common/filter-label.php' );

	echo '<div class="ava-color-image-list-wrapper">';
	...
	foreach ( $options as $value => $option ) {
		...
		if( '' !== $value ){
			include ava_smart_filters()->get_template( 'filters/color-image-item.php' );
		}
