 ...
 * 2. Add unique prefix for the class name, e.g. - Twentyseventeen_Ava_Smart_Filters_CX_Loader
 ...
 *     new Twentyseventeen_Ava_Smart_Filters_CX_Loader(
 *         array(
...
if ( ! class_exists( 'Ava_Smart_Filters_CX_Loader' ) ) {

	/**
	 * Define Ava_Smart_Filters_CX_Loader class
	 */
	class Ava_Smart_Filters_CX_Loader {
